...
const Forum = () => {
    ...
    let forumPost1 = new forumPost("Is this build good enough?", "Rate My Build", "Hideki1", new Date('April 28, 2022 15:47:00'), "Here's the current build: Asus z690 Wi-Fi prime motherboard, 2x16 32 gb of Corsair vengeance ddr5, 240mm msi aio, intel i7 12700k cpu, evga 3070 ti ftw 1tb each of m.2 Samsung and wd for os and games. Case Corsair 4000d Currently I really only play Minecraft and Genshin Impact very often. Otherwise it's a Twitch/Netflix/Reddit machine. I've been thinking of upgrading to a 4K monitor or 1400p ultrawide.(so I can sneak the current ultrawide into work and use it there)", 5, commentListPost1,"");
    ...
    let forumPost3 = new forumPost("Upgrade my current build", "Build Suggestions", "HTannyPie", new Date('April 25, 2022 15:47:00'), "Hello, I am new to this forum and want to ask for your suggestions. Here is my current build: CPU: AMD Ryzen 5 1600 GPU: NVIDIA GeForce GTX 1060  RAM: 16GB The performance of my PC is fine, although I do experience games crashing while I play them and CPU temperature reaches 80-90 degrees. When performing the usual tasks for school, my PC gets a bit slow. I currently have a budget of around 30,000 pesos to upgrade my build. Your suggestions would be appreciated. Thanks!", 8, commentListPost1,"");
